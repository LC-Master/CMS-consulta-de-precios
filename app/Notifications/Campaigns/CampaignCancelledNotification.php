...
class CampaignCancelledNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $mail = (new MailMessage)
            ->subject("Campaña cancelada: {$title}")
            ->greeting('Hola ' . ($notifiable->name ?? 'equipo') . ',')
            ->line("La campaña \"{$title}\" ha sido cancelada correctamente.")
    ...
    public function toArray(object $_notifiable): array
    {
        return [
            ...
            'title' => $this->campaign->getAttribute('title') ?? 'Campaña',
            'message' => 'La campaña ha sido cancelada correctamente.',
