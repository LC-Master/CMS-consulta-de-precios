...
class TokenCreatedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line("Se ha generado un token para que la tienda \"{$this->store->name}\" pueda acceder y reproducir sus campañas.")
            ->line("Nombre del token: {$this->tokenName}")
            ->line('Uso: este token autoriza la reproducción de las campañas de la tienda desde sistemas y dispositivos autorizados.')
