...
class TokenDeletedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line("Se ha eliminado el token que permitía a la tienda \"{$this->store->name}\" acceder y reproducir sus campañas.")
            ->line("Nombre del token: {$this->tokenName}")
            ->line('Consecuencias:')
            ->line('• La tienda perderá acceso automático a sus campañas y estas podrían dejar de reproducirse.')
