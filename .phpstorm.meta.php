...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\programador2.lfrq\Desktop\CMS_LOCATEL\public\storage' => 'string',
            ...
            'logs.soft_delete_old_logs' => 'string',
            'logs.force_delete_old_logs' => 'string',
            'mail.default' => 'string',
            ...
            'permissions.roles.admin' => 'array',
            'permissions.roles.consultor' => 'array',
            'permissions.roles.supervisor' => 'string',
            'permissions.roles.publicidad' => 'array',
            ...
            'services.syncMorningStart' => 'string',
            'services.syncAfternoonStart' => 'string',
...
'database.redis.cache.backoff_cap','dto.dto_version','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\programador2.lfrq\\Desktop\\CMS_LOCATEL\\public\\storage',
...
'logging.channels.browser.driver','logging.channels.browser.path','logging.channels.browser.level','logging.channels.browser.days','logs.soft_delete_old_logs',
'logs.force_delete_old_logs','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme','mail.mailers.smtp.url',
...
'permission.cache.expiration_time','permission.cache.key','permission.cache.store','permissions.permissions','permissions.roles.admin',
'permissions.roles.consultor','permissions.roles.supervisor','permissions.roles.publicidad','queue.default','queue.connections.sync.driver',
...
'services.syncMorningStart','services.syncAfternoonStart','session.driver','session.lifetime','session.expire_on_close',
...
'mcp.redirect_domains','excel.exports.chunk_size','excel.exports.pre_calculate_formulas','excel.exports.strict_null_comparison','excel.exports.csv.delimiter',
...
'password.confirm.store','sanctum.csrf-cookie','home','dashboard','media.index','media.create',
'media.store','media.show','media.edit','media.update','media.destroy',
'media.cdn','media.upload','logs.index','agreement.index','agreement.create',
'agreement.store','agreement.show','agreement.edit','agreement.update','agreement.destroy',
'api.suppliers.search','thumbnail.cdn','campaign.activate','campaign.cancel',
'campaign.report.list','campaign.export.list','campaign.export-detail','campaign.index','campaign.create',
'campaign.store','campaign.show','campaign.edit','campaign.update','campaign.destroy',
'calendar.show','campaign.calendar.export','campaignsHistory.history','campaignsHistory.show','campaignsHistory.restore',
'campaignsHistory.clone','user.index','user.create','user.store','user.show',
'user.edit','user.update','user.destroy','user.restore','centertokens.index',
'centertokens.store','centertokens.destroy','profile.edit','profile.update',
'profile.destroy','user-password.edit','user-password.update','appearance.edit','two-factor.show',
'stores.index','stores.force.sync','stores.force.token','stores.sync.url.update','stores.placeholder.update','storage.local',);
        registerArgumentsSet('views', 
'app','notifications::email','vendor.notifications.email','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'C:.Users.programador2.lfrq.Desktop.CMS_LOCATEL.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','DTO_VERSION','SOFT_DELETE_OLD_LOGS',
'FORCE_DELETE_OLD_LOGS','BROADCAST_CONNECTION','REVERB_APP_ID','REVERB_APP_KEY','REVERB_APP_SECRET',
